...
import 'package:kinopoisk_test/src/core/rest_client/src/http/check_exception_io.dart'
    if (dart.library.js_interop) 'package:kinopoisk_test/src/core/rest_client/src/http/check_exception_browser.dart';
